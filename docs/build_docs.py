...
class DocumentationBuilder:
    ...
    def extract_features(self):
        ...
        if (self.static_dir / 'manifest.json').exists():
            features.append("📱 **PWA**: Installable as native app")
        
        # Check for map
        if (self.static_dir / 'js' / 'app.js').exists():
            features.append("🗺️ **Interactive Map**: Leaflet.js with event markers")
        
        # Check for responsive design
        if (self.static_dir / 'css' / 'style.css').exists():
            features.append("📱 **Responsive**: Mobile-first design")
