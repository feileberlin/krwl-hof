...
- **src/** - All source code (Python modules, templates)
- **assets/** - Source assets (CSS, JS, HTML templates, SVG markers, favicon, manifest)
- **data/** - All data files (events, config, translations)
- **lib/** - Third-party libraries (Leaflet.js, Lucide)
- **public/** - Build output (generated HTML)
- **tests/** - Test files
...
│   │   ├── lucide_markers.py     # Marker base64 map
│   │   ├── scheduler.py          # Scheduling
│   │   ├── site_generator.py     # Site generation engine
...
│   │   ├── generate_icons.py          # Icon size generator
...
│   │   └── time-drawer.js        # Time-based markers
...
│   ├── svg/              # SVG marker icons (generated by lucide_markers.py)
│   ├── favicon.svg               # App icon (source)
│   ├── favicon-16x16.svg         # Generated favicon (16×16)
│   ├── favicon-32x32.svg         # Generated favicon (32×32)
│   ├── icon-192x192.svg          # Generated PWA icon (192×192)
│   ├── icon-512x512.svg          # Generated PWA icon (512×512)
│   ├── icon-*.svg                # Other PWA icons
...
│   ├── leaflet/                  # Leaflet.js library (fetched at build)
│   │   ├── leaflet.js
│   │   ├── leaflet.css
│   │   └── images/
│   └── lucide/                   # Lucide icons library (fetched at build)
│       └── lucide.min.js
│
├── public/                       # BUILD OUTPUT
│   └── index.html                # Generated single-file HTML (gitignored)
│
├── tests/                        # TEST FILES
│   ├── test_components.py
│   ├── test_scraper.py
...
- `assets/css/` → `src/css/`
- `assets/js/` → `src/js/`
- `src/templates/components/` → `assets/html/`
- `src-modules/` → `src/modules/` + `src/`
- `data/` → `data/`
- `config.json` → `data/config.json`
- `assets/lib/` → `public/` (libraries)
