...
{event_link}
    ...
    def load_component(self, component_path: str) -> str:
        """
        Load a component template from layouts/components/ directory.
        ...
        """
        full_path = self.base_path / 'layouts' / 'components' / component_path
        if not full_path.exists():
            raise FileNotFoundError(
                f"Component not found: {full_path}\n"
                f"Available components should be in layouts/components/:\n"
                f"  - html-head.html\n"
