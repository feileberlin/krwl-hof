...
Reads design tokens from data/config.json and generates CSS custom properties.
...
Output:
    src/templates/components/design-tokens.css
"""
...
def generate_css_custom_properties(design: Dict) -> str:
    ...
    lines = [
        ...
        " * Run: python3 src/templates/components/generate_design_tokens.py",
        " */",
        "",
        ":root {",
        "  /* ====================================================================== */",
        "  /* DESIGN TOKENS - Generated from data/config.json */",
        "  /* ====================================================================== */",
        ""
    ]
...
def main():
    ...
    # Load config
    print("Loading data/config.json...")
    try:
    ...
    if 'design' not in config:
        print("❌ Error: No 'design' section found in data/config.json")
        return 1
    
    design = config['design']
    print(f"✓ Found design section with {len(design)} categories")
    ...
    # Write output
    output_file = base_path / 'src' / 'templates' / 'components' / 'design-tokens.css'
    ...
    print(f"✓ Generated {token_count} CSS custom properties")
    print(f"\n✅ Output: {output_file}")
    ...
    print("   1. Edit design section in data/config.json")
    print("   2. Run: python3 src/templates/components/generate_design_tokens.py")
