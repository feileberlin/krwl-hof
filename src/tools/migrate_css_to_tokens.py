#!/usr/bin/env python3
"""
Migrate assets/css/style.css to use design tokens from data/config.json
...
def migrate_css_to_tokens(css_content: str, dry_run: bool = False) -> str:
    ...
    for i, line in enumerate(lines):
        ...
        if line.strip() == ':root {':
            ...
            output_lines.append('/* CSS Custom Properties are now generated from data/config.json design tokens */')
            output_lines.append('/* See: src/templates/components/design-tokens.css */')
            output_lines.append('/* Generated by: python3 src/templates/components/generate_design_tokens.py */')
            output_lines.append('')
...
def main():
    ...
    print("=" * 60)
    print("🎨 CSS Migration to Design Tokens")
    print("=" * 60)
    print(f"\nFile: {css_file}")
    ...
    if args.dry_run:
        ...
        print("\nOld variables → New design tokens:")
        print("  --bg-primary → --color-bg-primary")
        print("  --text-primary → --color-text-primary")
        print("  --accent-primary → --color-primary")
        print("  --barbie-red → --color-primary")
        print("  ... and more")
